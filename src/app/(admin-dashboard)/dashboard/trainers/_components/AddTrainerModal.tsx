...
const AddTrainerModal = ({ open, onClose, onSuccess, accessToken }: AddTrainerModalProps) => {
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            ...
                                            className="h-[48px] border border-gray-300 rounded-[8px] focus:ring-primary"
                                            {...field}
                                        />
                                    </FormControl>
                                    <FormMessage />
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            <Input
                                                ...
                                                placeholder="••••••••••"
                                                className="h-[48px] border border-gray-300 rounded-[8px] pr-10 focus:ring-primary"
                                                {...field}
                                            />
                                            <button
                                                type="button"
